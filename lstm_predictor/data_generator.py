...
class SheetImageGenerator(keras.utils.Sequence):
    def __init__(self, directory, batch_size=32, piece_size=(50, 50), pises_count=4):
    ...
    def __getitem__(self, item):
        ...
        image = keras.utils.img_to_array(keras.utils.load_img(file_pash))
...
if __name__ == '__main__':
    gen = SheetImageGenerator('data/data2', batch_size=10, piece_size=(200, 200))
    x, y = gen[0]
    print(x.shape)
    for i in range(5):
        plt.figure()
